...
class tablacuerpo{
            ...
            public static function DTablalinkuser($a,$link,$conexion)
                {
           ...
           echo "<tr id=".$row['Id'].">"; //hacen las filas
            ...
            if($link!=0){
          ?>
           <td width="20" ><a class="btn btn-danger" aria-controls="collapseExample" data-toggle="collapse" href="#collapseExample" data-role="updateUser" data-id="<?php echo $row["Id"] ?>">Modificar</a></td>
                 <?php       }
            echo "</tr>";
                                                                            }
            ...
            public static function DTablalink1($a,$link,$conexion)
                {
                                    $query =  mysqli_query($conexion,$a); //parte1
                                      ...
                                      for($i=0;$i<mysqli_num_fields($query);$i++) 
                                      {
                                         ...
                                         echo "<th>Acción</th><th>Materias</th><th>Asignar</th>
                                         </tr></thead><tbody>";
                                         while ($row=mysqli_fetch_assoc($query)) //finparte1
                                       {  
           echo "<tr id=".$row['id'].">"; //hacen las filas
          ...
          <td><a class="btn btn-info btn-sm" data-toggle="collapse" data-role="updateGrupo" href="#collapseGrupo"  data-id="<?php echo $row["id"] ?>">Grupo</a></td>
            ...
            public static function DTablalink111($a,$link,$conexion)
                {
                                    $query =  mysqli_query($conexion,$a); //parte1
                                      echo "<thead class='thead-dark'> <tr>";
                                      for($i=0;$i<mysqli_num_fields($query);$i++) 
                                      {
                                         ...
                                         echo "<th>Modificar</th><th>Asignar</th>
                                         </tr></thead><tbody>";
                                         while ($row=mysqli_fetch_assoc($query)) //finparte1
                                       {  
           echo "<tr id=".$row['id'].">"; //hacen las filas
          ...
          <td><a class="btn btn-info btn-sm" data-role="agrgrupo" href="grupos_prof.php?gr=<?php echo $row['id']?>"  data-id="<?php echo $row["id"] ?>">Grupos</a></td>
                 <?php       }
            echo "</tr>";
                                                                            }
            mysqli_free_result($query);
